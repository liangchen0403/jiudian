...
export default {
  ...
  methods: {
    ...
    handleFileChange(event) {
      ...
      if (selectedFile) {
        ...
        reader.onload = (e) => {
          this.previewImage = e.target.result; // 设置 previewImage 的值
        };
 ...
 async uploadAvatar() {
      try {
        ...
        await axios.post(`http://192.168.1.115:8080/admin/information/?id=${Number(localStorage.getItem('id'))}`, formData, 
        {
          headers: {
    ...
    sendmydata() {
      axios.post(
  "http://192.168.1.115:8080/admin/update",
  {
    ...
    headers: {
     ...
     async fetchDataFromServer() {
      try {
        ...
        const response = await axios.get(`http://192.168.1.115:8080/admin/information`, {
          headers: {
